   ...
   <div className="col">
    <div className="card m-4" id="this">
      ...
      <div className="card-body fondo">
        ...
        <p className="card-text somos"><strong>Dirección General</strong><br/>Comercial, Programas y Redes</p>
      </div>
</div></div>
<div className="col">
<div className="card m-4" id="this">
  ...
  <div className="card-body fondo">
    ...
    <p className="card-text somos"><strong>Administración</strong></p>
  </div>
</div></div>
<div className="col">
<div className="card m-4" id="this" >
...
<div className="card m-4" id="this">
  ...
  <div className="card-body fondo">
    <h3>Adrián</h3>
    <h3> Taboada</h3>
    <p className="card-text somos"> CEO 384 Group (Cuyo)</p>

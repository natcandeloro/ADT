...
import deploy from "../Assets/Statics/LOGOTIPO GRIS OSCURO.png"
...
export default function Footer() {
  return (
    <div className='footer'>
      ...
      <p className='pfoot'>Todos los derechos reservados <BiCopyright/> 2023 AIRE DE TRABAJO</p>
      ...
      <a href='https://wa.me/5492615434358' target="blank" ><p className='nati'>Powered by: <img src={deploy}  className="cande" alt=""/></p></a>
    </div> 
